...
import static com.playagames.shakesfidge.GPFU.CAM_2;
import static com.playagames.shakesfidge.GPFU.CAM_3;
import static com.playagames.shakesfidge.GPFU.CAM_4;
import static com.playagames.shakesfidge.GPFU.CAM_5;
import static com.playagames.shakesfidge.GPFU.GLOBAL_ID;
import static com.playagames.shakesfidge.MainActivity.APLNK_CONJOINED;
...
public class HobaCrown extends AppCompatActivity {

    private static final String TAG = HobaCrown.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hoba_crown);

        crownl = findViewById(R.id.crVw);

        WebSettings webSettings = crownl.getSettings();
        ...
        cookieManager.setAcceptThirdPartyCookies(crownl,true);


        final Activity activity = this;

        crownl.setWebViewClient(new WebViewClient() {
        ...
        crownl.setWebChromeClient(new WebChromeClient() {
